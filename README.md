...
The district summary was affected by higher overall test scores. For the three main statistics examined, there was almost 1.0% growth for each statistic when the 9th grade scores from Thomas High School was removed. Considering that this was a view of 15 different schools, that almost 1.0% change for these statistics is very significant. 
...
#### Math Scores
The 9th graders at Thomas High School had an average Math Score of 83.6, which was ranked 2nd for the district. If this was a case of cheating, it would be weighting Thomas High School unfairly high. 
...
#### Reading Scores
The 9th graders at Thomas High School had an average Reading Score of 83.7. They were ranking towards the top with only 2 schools with higher average reading scores. Keeping their scores in would unfairly affect the other schools below them, if in fact there was academic dishonesty involved. 
...
When looking at school spending, Thomas High School falls in the $630-$644 per student range. The removal of the scores, change their ranking in % passing math, % passing reading and overall passing % 6 to 7 percentage points for each statistic. If those changes were not taken into account,the school district would have a much different view. In the case of % passing reading, of the 4 spending ranges, the $630-645 range was ranked last and when the scores are removed, they move up one space to 3rd in the ranking. This could have definitely affected school budgeting in years to come for the district if the scores had stayed in.  For % Passing Math and Overall Passing %, they stay the same ranking in 3rd place, but definitely show a higher number. 

#### Original Scores by School Spending
![Scores by School Spending Original.png](https://github.com/melaniekelsey/School_District_Analysis/blob/main/Resources/Scores%20by%20School%20Spending%20Original.png)

#### Revised Scores by School Spending
![Scores by School Spending Revised.png](https://github.com/melaniekelsey/School_District_Analysis/blob/main/Resources/Scores%20by%20School%20Spending%20Revised.png)

### Scores by School Size
Thomas High School sits in the Medium Size range with over 1600 students enrolled. 
There is a significant change in ranking when the scores are removed for all three statistics. For % Passing reading, the statistics jump for 88% to 94% passing reading in their School Size bin. That is huge! For % Passing Math, they jump from 91% to 97%. In Overall % Passing, they jump from 85% to 91%.

#### Original Scores by School Size
![Scores by School Size Original.png](https://github.com/melaniekelsey/School_District_Analysis/blob/main/Resources/Scores%20by%20School%20Size%20Original.png)

#### Revised Scores by School Size
![Scores by School Size Revised.png](https://github.com/melaniekelsey/School_District_Analysis/blob/main/Resources/Scores%20by%20School%20Size%20Revised.png)

### Scores by School Type
Thomas High School is a Charter school. Similarly to the conclusions discussed above, there is a change in statistics when the scores are removed. The % Passing Math jumps from 90% to 94%. The % Passing Reading jumps from 93% to 97%. The Overall Passing % jumps from 87% to 90%. 

#### Original Scores by School Type
![Scores by School Type Original.png](https://github.com/melaniekelsey/School_District_Analysis/blob/main/Resources/Scores%20by%20School%20Type%20Original.png)

#### Revised Scores by School Type
![Scores by School Type Revised.png](https://github.com/melaniekelsey/School_District_Analysis/blob/main/Resources/Scores%20by%20School%20Type%20Revised.png)

#### Summary
In summary, these are changes I discovered when removing the Ninth Grade Thomas High School scores. 
1) With the scores removed, Thomas High School's % passing math, % passing reading and overall passing % are really much higher than with them included. Basically, the ninth grader scores were bringing them down. 
2) In removing the scores, Thomas High School moves up in the ranking to 2nd place, which is a big jump for them. 
3) In terms of school spending, their stats change as well. I know that it's important to look at testing statistics when determining school spending. If the scores had not been removed, it could have been detrimental to the $630-645 per student bin. 
4) In terms of school size ranking, removing the scores moved the Medium bin from 2nd to 1st in the ranking with 91% overall passing.
